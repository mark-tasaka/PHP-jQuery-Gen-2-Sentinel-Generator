...
<html>
<head>
<title>Launch Page: MCC Sentinel Character Generator</title>
...
<body>
	...
	<section>
		...
		<h1><img src="images/title.png" alt="Sentinel Character Generator" class="image" /></h1>
		...
		<form action="" id ="sentinelForm2"  target="_blank" method="post">
        ...
        $("#generate_characters2").click(function(){
            ...
            $("#sentinelForm2").attr('action', "character2/mcc_sentinel_"+ $("#level").val() + $("#abilityScores").val() +  ".php");
        });
